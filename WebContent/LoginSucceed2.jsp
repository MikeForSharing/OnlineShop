...
%>
			...
			<ul class="mod_user">
				<li id="J_ppIndex" class="mod_user_home hide">
				<a	href="http://www.paipai.com/?ptag=20316.1.13" class="c_tx1">拍拍首页</a>
				</li>
				<li id="userlogin" class="mod_user_home">
				欢迎您：<%=u.getUsername()%>
				</li>
				<li id="J_headLogin" class="mod_user_login"><a href="SelfService.jsp">用户自服务</a>
				</li>
